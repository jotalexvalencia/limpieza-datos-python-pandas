...
```mermaid
%% wrap the diagram in a scroll container using markdown fences
flowchart LR
...
- LinkedIn: [linkedin.com/in/jorgealexandervalencia](https://www.linkedin.com/in/jorgealexandervalencia/)
- GitHub: [github.com/jotalexvalencia](https://github.com/jotalexvalencia)
